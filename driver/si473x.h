...
/* AM: set AVC max gain and soft-mute max attenuation before applying the profile. */
void SI47XX_SetAmAudioControls(uint16_t avcMaxGain, uint8_t softMuteMaxAttn);
/* SSB: set AVC max gain and soft-mute max attenuation before applying the profile. */
